        ...
        public void OnClick(Android.Views.View view)
        {
            try
            {
                ...
                else
                {
                    ...
                    voiceIntent.PutExtra(RecognizerIntent.ExtraSpeechInputMinimumLengthMillis, 150000);
            ...
            if (e.RequestCode == VOICE)
            {
                if (e.ResultCode == Result.Ok)
                {
                    ...
                    if (matches.Count != 0)
                    {
                        ...
                        if (textInput.Length > PrismData.maxSpeechChar)
                            textInput = textInput.Substring(0, PrismData.maxSpeechChar);
