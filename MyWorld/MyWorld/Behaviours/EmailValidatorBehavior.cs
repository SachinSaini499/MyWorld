...
namespace MyWorld.Behaviours
{
    public class EmailValidatorBehavior : Behavior<Entry>
    {
        ...
        {
            this.IsValid = (Regex.IsMatch(e.NewTextValue, emailRegex, RegexOptions.IgnoreCase, TimeSpan.FromMilliseconds(250)));
            ((Entry)sender).TextColor = this.IsValid ? Color.Green : Color.Red;
